...
async def check_answer(question, answer) -> str:
    ...
    response = await client.responses.create(
        model="gpt-5-mini",
        instructions="Ты ассистент школьника, ты должен проверить ответ ученика на вопрос и сказать правильно он ответил или нет. Ответ должен быть в формате: 'Правильно' или 'Неправильно'.В ОТВЕТЕ НЕ БОЛЬШЕ ЧЕМ 1024 СИМВОЛОВ ПИШИ.",
        input=[
            {
                "role": "developer",
