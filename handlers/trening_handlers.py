        ...
        input=[
            {
                ...
                "content": f"Ты ассистент школьника {context.user_data['class_user']} класса, {topic_predmet_kontrol} вот тема и предмет по которому будет контрольная ученика."
                           f'Cоставь достаточное количество вопросов,что бы если он знал ответы на них с высокой долей вероятности получил 5 за контрольную. В ответе дай список вопросов в формате'
                           'вопрос1;вопрос2. Пиши только вопросы, ничего кроме них не пиши.',
            },
        ],
    )
